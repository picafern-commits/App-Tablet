  ...
  if (selectIP) {
    selectIP.innerHTML = `
      ...
      ${impressorasData.map(item => `
        <option value="<a href="http://<a href="http://${item.ip}" target="_blank" style="color:#60a5fa;text-decoration:none;font-weight:700;">${item.ip}</a>" target="_blank" style="color:#60a5fa;text-decoration:underline;">🌐 <a href="http://${item.ip}" target="_blank" style="color:#60a5fa;text-decoration:none;font-weight:700;">${item.ip}</a></a>">
          <a href="http://<a href="http://${item.ip}" target="_blank" style="color:#60a5fa;text-decoration:none;font-weight:700;">${item.ip}</a>" target="_blank" style="color:#60a5fa;text-decoration:underline;">🌐 <a href="http://${item.ip}" target="_blank" style="color:#60a5fa;text-decoration:none;font-weight:700;">${item.ip}</a></a> - ${item.localizacao} (${item.armazem})
        </option>
      `).join("")}
    `;
  }
  ...
  lista.innerHTML = criticas.map(({ item, info, criticalColors, monoCritical, residue }) => {
    ...
    return `
      <div class="dashboard-card dashboard-critical-card">
        ...
        <div class="meta-line">IP: <span class="meta-value"><a href="http://<a href="http://${item.ip}" target="_blank" style="color:#60a5fa;text-decoration:none;font-weight:700;">${item.ip}</a>" target="_blank" style="color:#60a5fa;text-decoration:underline;">🌐 <a href="http://${item.ip}" target="_blank" style="color:#60a5fa;text-decoration:none;font-weight:700;">${item.ip}</a></a></span></div>
...
function renderManutencoes(items) {
  ...
  lista.innerHTML = items.map(item => `
    <div class="pc-card manut-card">
      ...
      <div class="meta-line">IP: <span class="meta-value"><a href="http://<a href="http://<a href="http://${item.ip}" target="_blank" style="color:#60a5fa;text-decoration:none;font-weight:700;">${item.ip}</a>" target="_blank" style="color:#60a5fa;text-decoration:underline;">🌐 <a href="http://${item.ip}" target="_blank" style="color:#60a5fa;text-decoration:none;font-weight:700;">${item.ip}</a></a>" target="_blank" rel="noopener noreferrer"><a href="http://<a href="http://${item.ip}" target="_blank" style="color:#60a5fa;text-decoration:none;font-weight:700;">${item.ip}</a>" target="_blank" style="color:#60a5fa;text-decoration:underline;">🌐 <a href="http://${item.ip}" target="_blank" style="color:#60a5fa;text-decoration:none;font-weight:700;">${item.ip}</a></a></a></span></div>
  ...
  tbody.innerHTML = lista.map(item => {
    ...
    return `
      <tr>
        ...
        <td><a href="http://<a href="http://<a href="http://${item.ip}" target="_blank" style="color:#60a5fa;text-decoration:none;font-weight:700;">${item.ip}</a>" target="_blank" style="color:#60a5fa;text-decoration:underline;">🌐 <a href="http://${item.ip}" target="_blank" style="color:#60a5fa;text-decoration:none;font-weight:700;">${item.ip}</a></a>" target="_blank" rel="noopener noreferrer"><a href="http://<a href="http://${item.ip}" target="_blank" style="color:#60a5fa;text-decoration:none;font-weight:700;">${item.ip}</a>" target="_blank" style="color:#60a5fa;text-decoration:underline;">🌐 <a href="http://${item.ip}" target="_blank" style="color:#60a5fa;text-decoration:none;font-weight:700;">${item.ip}</a></a></a></td>
        <td>${badgeEstado(estado)}</td>
        <td>
          <div id="${tonerId}">${gerarHTMLBarraToner(null)}</div>
          <div class="table-actions" style="margin-top:8px;">
            <button class="action-btn ip" onclick="abrirIP('<a href="http://<a href="http://${item.ip}" target="_blank" style="color:#60a5fa;text-decoration:none;font-weight:700;">${item.ip}</a>" target="_blank" style="color:#60a5fa;text-decoration:underline;">🌐 <a href="http://${item.ip}" target="_blank" style="color:#60a5fa;text-decoration:none;font-weight:700;">${item.ip}</a></a>')">Abrir IP</button>
            ...
            <button class="action-btn" onclick="window.testarTonerImpressora('<a href="http://<a href="http://${item.ip}" target="_blank" style="color:#60a5fa;text-decoration:none;font-weight:700;">${item.ip}</a>" target="_blank" style="color:#60a5fa;text-decoration:underline;">🌐 <a href="http://${item.ip}" target="_blank" style="color:#60a5fa;text-decoration:none;font-weight:700;">${item.ip}</a></a>', '${tonerId}')">Testar toner</button>
          </div>
        </td>
      </tr>
    `;
    ...
    return `
      <tr>
        ...
        <td>
          ...
          <div class="table-actions" style="margin-top:8px;">
            ${webMode ? "" : `<button class="action-btn ip" onclick="abrirIP('<a href="http://<a href="http://${item.ip}" target="_blank" style="color:#60a5fa;text-decoration:none;font-weight:700;">${item.ip}</a>" target="_blank" style="color:#60a5fa;text-decoration:underline;">🌐 <a href="http://${item.ip}" target="_blank" style="color:#60a5fa;text-decoration:none;font-weight:700;">${item.ip}</a></a>')">Abrir IP</button>`}
            <button class="action-btn manut" onclick='abrirManutencaoDireta(${JSON.stringify(item)})'>Manutenção</button>
            ${webMode ? "" : `<button class="action-btn" onclick="window.testarTonerImpressora('<a href="http://<a href="http://${item.ip}" target="_blank" style="color:#60a5fa;text-decoration:none;font-weight:700;">${item.ip}</a>" target="_blank" style="color:#60a5fa;text-decoration:underline;">🌐 <a href="http://${item.ip}" target="_blank" style="color:#60a5fa;text-decoration:none;font-weight:700;">${item.ip}</a></a>', '${tonerId}')">Testar toner</button>`}
          </div>
        </td>
      </tr>
    `;
...
function renderTonerDiagnostics() {
  ...
  logEl.innerHTML = tonerDiagnosticsState.log.map(item => `
    <div class="diagnostics-log-item">
      ...
      <strong><a href="http://<a href="http://${item.ip}" target="_blank" style="color:#60a5fa;text-decoration:none;font-weight:700;">${item.ip}</a>" target="_blank" style="color:#60a5fa;text-decoration:underline;">🌐 <a href="http://${item.ip}" target="_blank" style="color:#60a5fa;text-decoration:none;font-weight:700;">${item.ip}</a></a></strong> · ${item.message}
    </div>
  `).join("");
}
