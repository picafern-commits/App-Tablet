...
(function(){
  ...
  function renderAlerts(items){
    ...
    if (!host) return;
    // v1.58.168: alertas de stock só aparecem quando a quantidade é 0.
  ...
  // v1.58.168 — botão QR no Stock: abre painel e usa o scanner antigo que passa o toner para Histórico.
...
// v1.58.168 — ouvir resumo global de stock/alertas
