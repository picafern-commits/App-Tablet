...
(function(){
  ...
  const PAGES = [
    { href:"index.html", label:"Dashboard", icon:"DB" },
    { href:"add-toner.html", label:"Adicionar Toner", icon:"+" },
    { href:"stock.html", label:"Stock", icon:"ST" },
    { href:"historico.html", label:"Histórico", icon:"HT" },
    { href:"tarefas.html", label:"Tarefas", icon:"TF" },
    { href:"scanner-ia.html", label:"Scanner IA", icon:"IA" },
    { href:"etiquetas-word.html", label:"Etiquetas Word", icon:"ET" },
    { href:"impressoras.html", label:"Impressoras", icon:"IP" },
    { href:"manutencao-impressoras.html", label:"Manutenção Impressoras", icon:"MN" },
    { href:"computadores.html", label:"Computadores", icon:"PC" },
    { href:"pistolas.html", label:"Pistolas CK65", icon:"CK" },
    { href:"radios.html", label:"Rádios", icon:"RD" },
    { href:"portas.html", label:"Portas Rede", icon:"PR" },
    { href:"diretorio.html", label:"Diretório", icon:"DR" },
    { href:"informacoes.html", label:"Informações", icon:"IN" },
    { href:"users.html", label:"Users", icon:"US" },
    { href:"diagnostico.html", label:"Diagnóstico", icon:"DG" },
    { href:"config.html", label:"Configurações", icon:"CF" }
  ];
...
(function(){
  ...
  const PAGE_ICONS = {
    "index.html":"DB", "add-toner.html":"+", "stock.html":"ST", "historico.html":"HT",
    "tarefas.html":"OK", "scanner-ia.html":"IA", "etiquetas-word.html":"ET",
    "impressoras.html":"IP", "manutencao-impressoras.html":"MN", "computadores.html":"PC",
    "pistolas.html":"CK", "radios.html":"RD", "portas.html":"PR", "diretorio.html":"DR",
