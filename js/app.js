...
function toggleFirestoreIds(){
  ...
  alert(
    window.showFirestoreIds
      ? "IDs Firestore ATIVADOS"
      : "IDs Firestore DESATIVADOS"
  );
...
function gerarFirestoreIdInline(obj){
